programa {
  funcao inicio() {
    ...
    se (n1 == n2 e n2 == n3) // Se n1 igual a n2 e n2 igual a n3...
    {
      escreva("os três numeros digitados são iguais") // Escreva que os números digitados são iguais
    }
    senao // Caso a afirmação acima seja mentira...
    {
